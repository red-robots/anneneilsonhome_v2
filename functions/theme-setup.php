...
// This theme styles the visual editor with editor-style.css to match the theme style.
	...
	register_nav_menu( 'sitemapshop', __( 'Sitemap Shop Menu', 'twentytwelve' ) );
	register_nav_menu( 'categories', __( 'Category Menu', 'twentytwelve' ) );
	...
	// Product Slider
	add_image_size( 'productslider', 200, 9999);
	add_image_size( 'slides', 1280, 450, true ); // (cropped)
	add_image_size( 'featured_thumbs', 250, 250, true ); // (cropped)
}
...
function twentytwelve_scripts_styles() {
	...
	//wp_enqueue_script( 'twentytwelve-googlemap', get_template_directory_uri() . '/js/googlemaps.js', array(), '1.0', true );
